...
Function SQLstuff
{
    ...
    Invoke-Sqlcmd -ServerInstance $instancename -Database $dbname -InputFile "C:\Source\Requirements2\Client_A_Contacts.sql" 
    $Insert = "INSERT INTO [$dbname].[dbo].[Client_A_Contacts] ([first_name],[Last_Name],[City],[County],[Zip],[OfficePhone],[MobilePhone])"
    $Newleads = Import-Csv "C:\Source\Requirements2\NewClientData.csv"
